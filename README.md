# MoreEnchantments
SDV mod to all enchanting tools with multiple enchantments, but with a configurable limit.

Original mod by [SlivaStari](https://github.com/SlivaStari)
Added a new feature/mechanic to limit how many enchantments can be added to the weapon/tools.
